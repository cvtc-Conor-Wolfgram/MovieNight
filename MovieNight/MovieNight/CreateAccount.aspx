...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="card text-white bg-secondary mb-3" style="max-width: 25rem;">
              ...
              <div class="card-body">
                  ...
                  <ul>
                    ...
                    <li class="textBox"><asp:TextBox ID="txtActiveEmail" runat="server" class="form-control" ToolTip="Enter Email" OnTextChanged="txtActiveEmail_TextChanged"  AutoPostBack="True"></asp:TextBox></li>
                    ...
                    <li><asp:TextBox ID="txtActivePass" runat="server" class="form-control" TextMode="Password" AutoCompleteType="Disabled"></asp:TextBox></li>
                    ...
                    <li><asp:Button ID="btnLogin" runat="server" class="btn btn-primary btn-lg" Text="Login" ValidationGroup="login" OnClick="btnLogin_Click" TabIndex="1" UseSubmitBehavior="False" /> </li>
                 </ul>
  ...
  <tbody>
    <tr class="table-secondary">
      ...
      <td>
          <ul>
              <li><asp:TextBox ID="txtUserName" runat="server" class="form-control" OnTextChanged="txtUserName_TextChanged" AutoPostBack="True"></asp:TextBox></li>
  ...
  <tbody>
    <tr class="table-secondary">
     ...
     <td>
          <ul>
            <li><asp:TextBox ID="txtUserPass" runat="server" class="form-control" TextMode="Password" AutoCompleteType="Disabled"></asp:TextBox></li>
  ...
  <tbody>
    <tr class="table-secondary">
     ...
     <td>
          <ul>
                <li><asp:TextBox ID="txtUserPassConfirm" runat="server" class="form-control" TextMode="Password"  AutoCompleteType="Disabled"></asp:TextBox></li>
