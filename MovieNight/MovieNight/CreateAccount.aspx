            ...
            <div class="card text-white bg-secondary mb-3" style="max-width: 20rem;">
              ...
              <div class="card-body">
                  ...
                  <ul>
                    ...
                    <li class="textBox"><asp:TextBox ID="txtActiveEmail" runat="server"></asp:TextBox></li>
                    ...
                    <li class="textBox"><asp:TextBox ID="txtActivePass" runat="server"></asp:TextBox></li>
        ...
        <div class="form-create">
           <div class="card text-white bg-secondary mb-3" style="max-width: 20rem;">
            ...
            <ul>            
                ...
                <li class="textBox"><asp:TextBox ID="txtUserName" runat="server"></asp:TextBox></li>
                ...
                <li class="textBox"><asp:TextBox ID="txtFName" runat="server"></asp:TextBox></li>
                <li><asp:Label ID="lblLName" runat="server" Text="Last Name:"></asp:Label></li>
                <li class="textBox"><asp:TextBox ID="txtLName" runat="server"></asp:TextBox></li>
                <li><asp:Label ID="lblUserEmail" runat="server" Text="Email:"></asp:Label></li>
                <li class="textBox"><asp:TextBox ID="txtUserEmail" runat="server"></asp:TextBox></li>
                ...
                <li class="textBox"><asp:TextBox ID="txtUserPass" runat="server"></asp:TextBox></li>
                ...
                <li class="textBox"><asp:TextBox ID="txtUserPassConfirm" runat="server"></asp:TextBox></li>
