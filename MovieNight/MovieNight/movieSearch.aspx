...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 50%; margin-top: 5px; margin-left: 25%; margin-right: 25%; text-align: center;"><asp:Button ID="btnSearch" class="btn btn-primary btn-sm" runat="server" Text="Search Movies" OnClick="btnSearch_Click"/></div>
