        ...
        <div class="card-body">
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane fade " id="groupCreate">
                    <ul class="acctInfo">
                        <li>
                            <asp:Label ID="lblGroupName" runat="server" Text="Group Name:"></asp:Label><asp:TextBox ID="txtGroupName" runat="server" MaxLength="25" class="form-control"></asp:TextBox></li>
                        <li>
                            <asp:Button ID="btnCreate" runat="server" Text="Create Group" OnClick="btnCreate_Click" class="btn btn-primary" /></li>
                ...
                <div class="tab-pane fade " id="groupJoin">
                    <ul class="acctInfo">
                        <li>
                            <asp:Label ID="lblGroupCode" runat="server" Text="Enter Group Code:"></asp:Label><asp:TextBox ID="txtGroupCode" runat="server" class="form-control"></asp:TextBox></li>
                        <li>
